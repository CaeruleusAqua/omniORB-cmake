...
set(PYTHONPATH_INSTALL "PYTHONPATH=\"${PYTHON_SITE}\"")
...
if (WIN32)
    ...
    FOREACH (_PATH ${Python_RUNTIME_LIBRARY_DIRS})
        set(PATH_ENV "${_PATH}$<SEMICOLON>${TEST}")
    ENDFOREACH ()
    ...
    set(OMNIIDL_EXEC_INSTALL ${CMAKE_COMMAND} -E env ${PATH_ENV} ${PYTHONHOME} ${PYTHONPATH_INSTALL} $<TARGET_FILE:omniidl>)
    ...
    set(OMNIIDL_EXEC_INSTALL ${CMAKE_COMMAND} -E env ${PYTHONPATH_INSTALL} ${Python_EXECUTABLE} ${PROJECT_BINARY_DIR}/bin/omniidl)
