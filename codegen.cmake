...
ADD_CUSTOM_COMMAND(OUTPUT ${GEN_DIR}/lib/omniORB/omniORB4/ir_defs.hh ${GEN_DIR}/lib/omniORB/omniORB4/ir_operators.hh ${GEN_DIR}/lib/omniORB/omniORB4/ir_poa.hh ${GEN_DIR}/lib/omniORB/omniORB4/irDynSK.cc ${GEN_DIR}/lib/omniORB/omniORB4/irSK.cc
        COMMAND ${CMAKE_COMMAND} -E env ${PYTHONPATH} ${PYTHONHOME} ${OMNIIDL_EXEC} ${OMNIIDL_PLATFORM_FLAGS} -bcxx -p${CMAKE_SOURCE_DIR}/src/lib/omniORB/python3 -I${CMAKE_SOURCE_DIR}/idl -Wbdebug -Wba -I${CMAKE_SOURCE_DIR}/idl -Wbdebug -WbF -I. -I${CMAKE_SOURCE_DIR}/idl -I${CMAKE_SOURCE_DIR} -C${GEN_DIR}/lib/omniORB/omniORB4 ${CMAKE_SOURCE_DIR}/idl/ir.idl
...
ADD_CUSTOM_COMMAND(OUTPUT ${GEN_DIR}/lib/omniORB/omniORB4/pollable_defs.hh ${GEN_DIR}/lib/omniORB/omniORB4/pollable_operators.hh ${GEN_DIR}/lib/omniORB/omniORB4/pollable_poa.hh ${GEN_DIR}/lib/omniORB/omniORB4/pollableDynSK.cc ${GEN_DIR}/lib/omniORB/omniORB4/pollableSK.cc
...
ADD_CUSTOM_COMMAND(OUTPUT ${GEN_DIR}/lib/omniORB/omniORB4/omniTypedefs.hh ${GEN_DIR}/lib/omniORB/omniORB4/omniTypedefsSK.cc
        COMMAND ${CMAKE_COMMAND} -E env ${PYTHONPATH} ${PYTHONHOME} ${OMNIIDL_EXEC} ${OMNIIDL_PLATFORM_FLAGS} -bcxx -p${CMAKE_SOURCE_DIR}/src/lib/omniORB/python3 -I${CMAKE_SOURCE_DIR}/idl -Wbdebug -C${GEN_DIR}/lib/omniORB/omniORB4 ${CMAKE_SOURCE_DIR}/idl/omniTypedefs.idl
...
ADD_CUSTOM_COMMAND(OUTPUT ${GEN_DIR}/lib/omniORB/omniORB4/omniConnectionData.hh ${GEN_DIR}/lib/omniORB/omniORB4/omniConnectionDataSK.cc
        COMMAND ${CMAKE_COMMAND} -E env ${PYTHONPATH} ${PYTHONHOME} ${OMNIIDL_EXEC} ${OMNIIDL_PLATFORM_FLAGS} -bcxx -p${CMAKE_SOURCE_DIR}/src/lib/omniORB/python3 -I${CMAKE_SOURCE_DIR}/idl -Wbdebug -C${GEN_DIR}/lib/omniORB/omniORB4 ${CMAKE_SOURCE_DIR}/idl/omniConnectionData.idl
...
ADD_CUSTOM_COMMAND(OUTPUT ${GEN_DIR}/lib/omniORB/omniORB4/messaging.hh ${GEN_DIR}/lib/omniORB/omniORB4/messagingSK.cc
        COMMAND ${CMAKE_COMMAND} -E env ${PYTHONPATH} ${PYTHONHOME} ${OMNIIDL_EXEC} ${OMNIIDL_PLATFORM_FLAGS} -bcxx -p${CMAKE_SOURCE_DIR}/src/lib/omniORB/python3 -I${CMAKE_SOURCE_DIR}/idl -Wbdebug -C${GEN_DIR}/lib/omniORB/omniORB4 ${CMAKE_SOURCE_DIR}/idl/messaging.idl
...
ADD_CUSTOM_COMMAND(OUTPUT ${GEN_DIR}/lib/omniORB/omniORB4/messaging_policy.hh ${GEN_DIR}/lib/omniORB/omniORB4/messaging_policySK.cc
        COMMAND ${CMAKE_COMMAND} -E env ${PYTHONPATH} ${PYTHONHOME} ${OMNIIDL_EXEC} ${OMNIIDL_PLATFORM_FLAGS} -bcxx -p${CMAKE_SOURCE_DIR}/src/lib/omniORB/python3 -I${CMAKE_SOURCE_DIR}/idl -Wbdebug -C${GEN_DIR}/lib/omniORB/omniORB4 ${CMAKE_SOURCE_DIR}/idl/messaging_policy.idl
...
ADD_CUSTOM_COMMAND(OUTPUT ${GEN_DIR}/lib/omniORB/omniORB4/compression.hh ${GEN_DIR}/lib/omniORB/omniORB4/compressionDynSK.cc ${GEN_DIR}/lib/omniORB/omniORB4/compressionSK.cc
        COMMAND ${CMAKE_COMMAND} -E env ${PYTHONPATH} ${PYTHONHOME} ${OMNIIDL_EXEC} ${OMNIIDL_PLATFORM_FLAGS} -bcxx -p${CMAKE_SOURCE_DIR}/src/lib/omniORB/python3 -I${CMAKE_SOURCE_DIR}/idl -Wbdebug -Wba -I. -I${CMAKE_SOURCE_DIR}/idl -C${GEN_DIR}/lib/omniORB/omniORB4 ${CMAKE_SOURCE_DIR}/idl/compression.idl
...
ADD_CUSTOM_COMMAND(OUTPUT ${GEN_DIR}/lib/omniORB/omniORB4/ziop_defs.hh ${GEN_DIR}/lib/omniORB/omniORB4/ziop_operators.hh ${GEN_DIR}/lib/omniORB/omniORB4/ziop_poa.hh ${GEN_DIR}/lib/omniORB/omniORB4/ziopDynSK.cc ${GEN_DIR}/lib/omniORB/omniORB4/ziopSK.cc
        COMMAND ${CMAKE_COMMAND} -E env ${PYTHONPATH} ${PYTHONHOME} ${OMNIIDL_EXEC} ${OMNIIDL_PLATFORM_FLAGS} -bcxx -p${CMAKE_SOURCE_DIR}/src/lib/omniORB/python3 -I${CMAKE_SOURCE_DIR}/idl -Wbdebug -I. -I${CMAKE_SOURCE_DIR}/idl -WbF -Wba -C${GEN_DIR}/lib/omniORB/omniORB4 ${CMAKE_SOURCE_DIR}/idl/ziop.idl
...
ADD_CUSTOM_COMMAND(OUTPUT ${GEN_DIR}/lib/omniORB/omniORB4/distdate.hh
        COMMAND ${CMAKE_COMMAND} -E env ${PYTHONPATH} ${PYTHON_EXECUTABLE} ${CMAKE_SOURCE_DIR}/bin/scripts/distdate.py < ${CMAKE_SOURCE_DIR}/update.log > ${GEN_DIR}/lib/omniORB/omniORB4/distdate.hh
